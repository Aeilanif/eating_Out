...
In conclusion there is a significant difference between the white and black with frequency of eating out there are a statistical difference between at least two races with the frequency of eating out the only variables that are different are the White and the Black data there p value is to low so we have to reject the $H_0$.
